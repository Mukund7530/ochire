...
function Last() {
    return (
        <div className='w-full h-screen bg-zinc-900 p-10 flex'>
            <div className='w-1/2 font-["Neue_Montreal"] h-full flex flex-col justify-between'>
                <div className='heading '>
                    <h1 className='text-7xl tracking-tighter uppercase font-semibold'>eye-</h1>
                    <h1 className='text-7xl tracking-tighter uppercase font-semibold'>opening</h1>
                </div>
            ...
            <div className='w-1/2 '>
                <h1 className='text-7xl tracking-tighter uppercase font-semibold'>Presentations</h1>
                <div className='link group flex gap-40 '>
                    <div className='links1 mt-20'>
                        <h1 className='uppercase underline mb-5'>links:</h1>
                    ...
                    <div className='links2 mt-20'>
                        <h1 className='uppercase underline mb-5'>Email Us:</h1>
                        <a className='block text-xl font-light' href="">hello@ochi.design</a>
                    </div>
                </div>
                <div className='link group flex gap-40 -mt-10'>
                    <div className='links2 mt-20'>
                        <h1 className='uppercase underline mb-2'>location:</h1>
                        <a className='block text-xl font-light' href="">202-1965 W 4th Ave Vancouver,Canada ,30 Chukarina St Lviv, Ukrain</a>
                    </div>
                </div>

                <div className='links2 flex items-center justify-between mt-14'>
